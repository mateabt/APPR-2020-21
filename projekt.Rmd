...
- `leto` - spremenljivka:letih pri kateri gledamo BDP(število)
...
```{r graf3, echo=FALSE, fig.align='center',fig.cap='Graf3'}
graf.napoved1
```
...
```{r graf4, echo=FALSE, fig.align='center',fig.cap='Graf4'}
graf.napoved2
```
