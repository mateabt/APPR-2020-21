...
1. `Trgovinski_partnerji` - podatki o Nemških trgovskih partnerjev
  - `Drzave` -spremenljivka: trgovske partnerje
  - `Uvoz` - spremenljivka: ime države iz katere Nemčija uvaža (besedilo),
  - `Izvoz` - spremenljivka:ime države iz katere Nemčija uvaža (besedilo),
  - `Neto izvoz` - spremenljivka: Izvoz minus uvoz za države (besedilo).
  - `Vrednost` - metitev:količino prej naštetih spremenljivk
